...
* `CLASSIFIER_CRON_SCHEDULE`: `"0 0 * * *"`
	* This is the cron schedule for running the clustering process in daemon mode. Setting this value will allow you to automate the clustering process to run at regular intervals. Adjust the schedule according to your needs and the frequency of new data being added.