...
class FeedXSerializer(serializers.Serializer):
    ...
    title = serializers.CharField(max_length=1000, help_text=TITLE_HELP_TEXT, required=False)
    description = serializers.CharField(max_length=1000, help_text=DESCRIPTION_HELP_TEXT, required=False)
...
class SkeletonFeedXSerializer(FeedXSerializer):
    ...
    profile_id = None
    title = serializers.CharField(required=True, help_text=TITLE_HELP_TEXT)
    description = serializers.CharField(required=True, help_text=DESCRIPTION_HELP_TEXT)
